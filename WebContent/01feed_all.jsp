...
.path_container .col_1st .btn_feed {
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		let feed = $('.path_container .col_1st .path_icon .btn_feed');
		
		$(feed).click(function () {
			location.href = './01feed_all.jsp?kind=사료';
		});
	});
