...
.path_container .col_1st .btn_fashion {
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		let fashion = $('.path_container .col_1st .path_icon .btn_fashion');
		
		$(fashion).click(function () {
			location.href = './01fashion_all.jsp?kind=패션';
		});
	});
		...
		<div class="row third_row">
			...
			<div class="col-lg col-md col-sm col_3rd">
				...
				<div class="path_btns" align="center">
					...
					<button>신발/양말</button>
					<button>외투</button>
					<button>원피스/올인원</button>
					<button>코스튬</button>
					<button>셔츠/상의</button>
					<button>기타패션용품</button>
				</div>
