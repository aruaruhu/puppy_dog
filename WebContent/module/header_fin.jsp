...
// 	});
    ...
    /* 두번째 헤더의 우측 장바구니 연결 */
	function cartpage() {
      let CartPageURL = "http://localhost:8080/semi_project/cartShowup";
    ...
    $('.third_header .col_2nd .btn_group:last-child .btn').hover(
        ...
        /* 세번째 헤더 중앙 링크 연결 */
$(document).ready(function() {
  $('.third_header .col_2nd .btn_group:nth-of-type(1)').click(function() {
    window.location.href = 'http://localhost:8080/semi_project/01snack_all.jsp?kind=간식';
    console.log('버튼 1이 클릭되었습니다.');
  });

  $('.third_header .col_2nd .btn_group:nth-of-type(2)').click(function() {
    window.location.href = 'http://localhost:8080/semi_project/01feed_all.jsp?kind=사료';
    console.log('버튼 2이 클릭되었습니다.');
  });

  $('.third_header .col_2nd .btn_group:nth-of-type(3)').click(function() {
    window.location.href = 'http://localhost:8080/semi_project/01beauty_all.jsp?kind=미용';
    console.log('버튼 3이 클릭되었습니다.');
  });

  $('.third_header .col_2nd .btn_group:nth-of-type(4)').click(function() {
    window.location.href = 'http://localhost:8080/semi_project/01fashion_all.jsp?kind=패션';
        ...
        <div class="row first_row">
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 col_4th">
                ...
                <c:if test="${sessionScope.user_id == null }">
                    ...
                    <button onclick="location.href='userLogin.jsp'" type="button" class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    로그인 / 회원가입
                    </button>
                  ...
                  <div class="offcanvas-body first_offcanvas_body">
                    ...
                    <div class="offcanvas_scroll_part">
                        <div class="offcanvas_list_part">
                            <p><a href="./01snack_all.jsp?kind=간식">간식</a></p>
                            <hr>
                        ...
                        <div class="offcanvas_list_part">
                            <p><a href="./01feed_all.jsp?kind=사료">사료</a></p>
                            <hr>
                            <p><a href="#">건식사료</a></p>
                            <p><a href="#">습식사료</a></p>
                            <p><a href="#">우유/분유</a></p>
                        ...
                        <div class="offcanvas_list_part">
                            <p><a href="./01beauty_all.jsp?kind=미용">미용용품</a></p>
                            <hr>
                            <p><a href="#">드라이기</a></p>
                            <p><a href="#">발톱관리용품</a></p>
                            <p><a href="#">브러시</a></p>
                        ...
                        <div class="offcanvas_list_part">
                            <p><a href="./01fashion_all.jsp?kind=패션">패션용품</a></p>
                            <hr>
                            <p><a href="#">레인코트</a></p>
                            <p><a href="#">신발/양말</a></p>
                            <p><a href="#">외투</a></p>
