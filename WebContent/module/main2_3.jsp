    ...
    <!-- 페이지네이션 영역 -->
    		<nav aria-label="Search results pages">
				 <ul class="pagination justify-content-center first_pagination">
				   <li class="page-item">
				     <a class="page-link" href="MainPage2.jsp" aria-label="Previous">
				   ...
				   <li class="page-item active"><a class="page-link" href="MainPage3.jsp">3</a></li>
...
<script type="text/javascript">
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		// 기본 페이지
		let pageToInclude = "MainPage3.jsp"; 
