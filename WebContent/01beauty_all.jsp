...
.path_container .col_1st .btn_beauty {
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		let beauty = $('.path_container .col_1st .path_icon .btn_beauty');
		
		$(beauty).click(function () {
			location.href = './01beauty_all.jsp?kind=미용';
		});
	});
		...
		<div class="row third_row">
			...
			<div class="col-lg col-md col-sm col_3rd">
				...
				<div class="path_btns" align="center">
					<button>ALL</button>
					<button>드라이기</button>
					<button>발톱관리용품</button>
					<button>브러쉬</button>
					<button>샤워기/타월</button>
					<button>샴푸/린스</button>
					<button>이발기/가위</button>
					<button>기타미용용품</button>
				</div>
...
<%
    ...
    try {
        ...
        PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM product WHERE pro_kind = ?");
